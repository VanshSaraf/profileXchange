...
export default function Messages() {
    ...
    const filteredChats = useMemo(() => {
        ...
        return chats.filter((chat) => {
            ...
            // Safe check: default to empty string if data is missing
            const listingTitle = chat.listing?.title?.toLowerCase() || "";
            const userName = chatUser?.name?.toLowerCase() || "";

            return listingTitle.includes(query) || userName.includes(query);
        });
    ...
    return (
        <div className="mx-auto min-h-screen mt-15 px-6 md:px-16 lg:px-24 xl:px-32">
            <div className="py-10">
                {/* Header */}
                <div className="mb-8">
...
//   return (
//     <div className="mx-auto min-h-screen px-6 mt-10 md:px-16 lg:px-24 xl:px-32">
//       <div className="py-10">
//         {/* Header */}
//         <div className="mb-8">
//           <h1 className="text-3xl font-bold text-gray-800 mb-2">Messages</h1>
