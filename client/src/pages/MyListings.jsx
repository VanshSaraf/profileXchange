...
// // //     // Refactored: Removed Backend Logic & Modal Triggers
// // //     const toggleStatus = (listingId) => {
// // //         alert(`Status toggle for listing ${listingId} requires backend integration.`);
// // //     };

// // //     const deleteListing = (listingId) => {
// // //         const confirm = window.confirm('Are you sure you want to delete this listing? (Simulation)');
// // //         if (confirm) {
// // //             alert(`Listing ${listingId} deleted (Simulation only).`);
// // //         }
// // //     };

// // //     const markAsFeatured = (listingId) => {
// // //         alert(`Feature request for listing ${listingId} requires backend integration.`);
// // //     };

// // //     const handleAddCredentials = () => {
// // //         alert("Credential submission modal is currently disabled.");
// // //     };

// // //     const handleWithdraw = () => {
// // //         alert("Withdrawal modal is currently disabled.");
// // //     };

// // //     return (
// // //         <div className='px-6 md:px-16 mt-10 lg:px-24 xl:px-32 pt-8'>
// // //             {/* Header */}
// // //             <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-8'>
// // //                 <div>
// // //                     <h1 className='text-3xl font-bold text-gray-800'>My Listings</h1>
...
// // //                     { label: 'Available', value: balance.available, icon: CoinsIcon },
// // //                 ].map((item, index) => (
// // //                     <div onClick={() => item.label === 'Available' && handleWithdraw()} key={index} className={`flex flex-1 items-center justify-between p-4 rounded-lg border border-gray-100 ${item.label === 'Available' ? 'cursor-pointer hover:bg-gray-50' : ''}`}>
// // //                         <div className='flex items-center gap-3'>
// // //                             <item.icon className='text-gray-500 w-6 h-6' />
// // //                             <span className='font-medium text-gray-600'>{item.label}</span>
// // //                         </div>
...
// // //                                                             {!listing.isCredentialSubmitted && (
// // //                                                                 <>
// // //                                                                     <button onClick={handleAddCredentials} className='flex items-center gap-2 text-nowrap hover:text-indigo-600'>
// // //                                                                         Add Credentials
// // //                                                                     </button>
// // //                                                                     <hr className='border-gray-200 my-2' />
// // //                                                                 </>
// // //                                                             )}
// // //                                                             <button className='text-nowrap cursor-default'>
// // //                                                                 Status :{' '}
// // //                                                                 <span className={listing.isCredentialSubmitted ? (listing.isCredentialVerified ? (listing.isCredentialChanged ? 'text-green-600' : 'text-indigo-600') : 'text-slate-600') : 'text-red-600'}>
// // //                                                                     {listing.isCredentialSubmitted ? (listing.isCredentialVerified ? (listing.isCredentialChanged ? 'Changed' : 'Verified') : 'Submitted') : 'Not Submitted'}
// // //                                                                 </span>
...
// //     // --- Mock Actions (Simulation Only) ---

// //     const toggleStatus = (listingId) => {
// //         toast.success(`Listing ${listingId} status toggled (Simulation)`);
// //     };

// //     const deleteListing = (listingId) => {
// //         const confirm = window.confirm('Are you sure you want to delete this listing? (Simulation)');
// //         if (!confirm) return;
// //         toast.success(`Listing ${listingId} deleted (Simulation)`);
// //     };

// //     const markAsFeatured = (listingId) => {
// //         toast.success(`Listing ${listingId} marked as featured (Simulation)`);
// //     };

// //     return (
// //         <div className='px-6 md:px-16 lg:px-24 mt-10 xl:px-32 pt-8'>
// //             {/* Header */}
// //             <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-8'>
// //                 <div>
// //                     <h1 className='text-3xl font-bold text-gray-800'>My Listings</h1>
...
// //                         className={`flex flex-1 items-center justify-between p-4 rounded-lg border border-gray-100 ${item.label === 'Available' ? 'cursor-pointer hover:bg-gray-50 active:bg-gray-100' : ''}`}
// //                     >
// //                         <div className='flex items-center gap-3'>
// //                             <item.icon className='text-gray-500 w-6 h-6' />
// //                             <span className='font-medium text-gray-600'>{item.label}</span>
...
// //                                                     <div className='invisible group-hover:visible absolute right-0 top-0 pt-4.5 z-10'>
// //                                                         <div className='bg-white text-gray-600 text-xs rounded border border-gray-200 p-2 px-3 shadow-lg min-w-[150px]'>
// //                                                             {!listing.isCredentialSubmitted && (
// //                                                                 <>
// //                                                                     <button 
// //                                                                         onClick={() => setShowCredentialSubmission(listing)} 
// //                                                                         className='flex items-center gap-2 text-nowrap hover:text-indigo-600 w-full text-left'
// //                                                                     >
// //                                                                         Add Credentials
// //                                                                     </button>
// //                                                                     <hr className='border-gray-200 my-2' />
...
// //                                         <div className='flex items-center space-x-2'>
// //                                             {listing.status !== 'sold' && (
// //                                                 <button onClick={() => deleteListing(listing.id)} className='p-2 border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-red-500 transition-colors'>
// //                                                     <TrashIcon className='size-4' />
// //                                                 </button>
// //                                             )}
// //                                             <button onClick={() => navigate(`/edit-listing/${listing.id}`)} className='p-2 border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-indigo-600 transition-colors'>
// //                                                 <Edit className='size-4' />
// //                                             </button>
// //                                             <button onClick={() => toggleStatus(listing.id)} className='p-2 border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-purple-600 transition-colors'>
// //                                                 {listing.status === 'active' && <EyeOffIcon className='size-4' />}
// //                                                 {listing.status !== 'active' && <EyeIcon className='size-4' />}
// //                                             </button>
// //                                         </div>
...
// import { Eye, Edit, Plus, TrendingUp, DollarSign, Users, CheckCircle, Clock, XCircle, EyeOffIcon, EyeIcon, LockIcon, BanIcon, TrashIcon, StarIcon } from 'lucide-react';
// import { useDispatch, useSelector } from 'react-redux';
// import { platformIcons } from '../assets/assets';
// import { useNavigate } from 'react-router-dom';
// import { toast } from 'react-hot-toast';
...
// const MyListings = () => {
//     // FIXED: Removed 'balance' destructuring to prevent crash
...
//     return (
//         <div className='px-6 md:px-16 mt-15 lg:px-24 xl:px-32 pt-8'>
//             {/* Header */}
//             <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-8'>
//                 <div>
//                     <h1 className='text-3xl font-bold text-gray-800'>My Listings</h1>
...
const MyListings = () => {
    ...
    return (
        <div className='px-6 md:px-16 mt-13 lg:px-24 xl:px-32 pt-8'>
            {/* Header */}
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-8'>
                <div>
                    <h1 className='text-3xl font-bold text-gray-800'>My Listings</h1>
